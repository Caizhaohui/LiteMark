...
(function() {
  ...
  function updatePreview(msg) {
    const container = document.getElementById('litemark-content');
    ...
    // Refresh TOC on live updates (for heading changes etc.)
    if (msg.toc) {
      const tocAside = document.querySelector('.litemark-toc');
      if (tocAside) {
        tocAside.innerHTML = msg.toc;
      }
    }
  ...
  function renderMath() {
    if (typeof renderMathInElement !== 'undefined') {
      renderMathInElement(document.getElementById('litemark-content') || document.body, {
        delimiters: [
